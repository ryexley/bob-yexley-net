...
- [ ] **Screen Lock** - It would be reall nice, on the blip detail view, to have the ability to lock the screen on-demand, to prevent the device from foing to sleep when I'm making live updates. [Claude gave me a good solution for this here in this conversation](https://claude.ai/share/2fa5ee8f-c962-47dd-b7b8-bc07bb1e03ed).
