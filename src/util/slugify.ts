// Adapted from https://github.com/simov/slugify
// Because it does not support a native ESM export
...
export function generateSlug(string, options) {
...
generateSlug.extend = function (customMap) {
